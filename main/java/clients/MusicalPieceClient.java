...
/**
 * Jersey REST client generated for REST resource:MusicalPieceFacadeREST
 * [eu.cz.fit.vahalto1.orchestrasheetapplication.musicalpiece]<br>
 * USAGE:
 * <pre>
 *        MusicalPieceClient client = new MusicalPieceClient();
 ...
 */
public class MusicalPieceClient {
    ...
    public <T> T getSheets_XML(Class<T> responseType, String id) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("sheets/{0}", new Object[]{id}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T getSheets_JSON(Class<T> responseType, String id) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("sheets/{0}", new Object[]{id}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
