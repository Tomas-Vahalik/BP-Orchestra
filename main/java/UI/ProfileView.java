...
public class ProfileView {
    ...
    public VerticalLayout getLayout(){
        ...
        if(user == null)user = uc.find_XML(User.class, ui.userName);
        ...
        //oldPasswordLayout.setVisible(false);
        ...
        if(!(ui.userName.equals(user.getLogin()))){
            //System.out.println(ui.userName + " " + user.getLogin());
        ...
        else instrumentGrid.setSelectionMode(Grid.SelectionMode.NONE);        
